...
- [[konrad-kording|Konrad Kording]]: third paper in the wiki by Kording — bridges his methodological/data-science work (this paper, plus the Jonas & Kording 2015 cell-type-discovery method whose limitations the paper itself documents) with his computational-credit-assignment lineage ([[kording-konig-2001-two-integration-sites|2001]], [[jones-2020-dendritic-computation-power|2020]]).
