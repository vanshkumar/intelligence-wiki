...
- **[[Active Inference]]** / **[[free-energy-principle|Free Energy Principle]]**: [[friston-2010-free-energy-principle|Friston (2010)]] generalizes the Helmholtz free energy to include action — agents minimize free energy not just by updating their recognition model but by acting on the world to make their sensations match predictions. The variational lower bound is the same; active inference adds a policy distribution over actions and the canonical-microcircuit reading (forward errors / backward predictions, precision-weighted gradient on `F`) of how cortex might implement it.
